                ...
                >
                  <div className="border rounded-lg p-4 hover:border-primary transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                      <div>
                        <p className="text-2xl font-semibold">{property.clicks}</p>
                        <p className="text-sm text-muted-foreground">Clicks/day</p>
                      </div>
                      <div>
                        <p className="text-2xl font-semibold">{property.impressions}</p>
                        <p className="text-sm text-muted-foreground">Impressions/day</p>
                      </div>
                    </div>
                  </div>
                </Link>
